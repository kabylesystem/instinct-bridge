...
from .source import MigrationError, loads_plan

TTL = 900


def create_app(token, expected_host, destination_factory=brave_session):
...
def main():
    ...
    print(f"Instinct Bridge — open locally: http://{host}/#{token}", flush=True)
